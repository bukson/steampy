...
from steampy.exceptions import ApiException, LoginRequired, TooManyRequests
...
class SteamMarket:
    def __init__(self, session: Session) -> None:
        ...
        self._steam_guard: Dict[str, str] = {}
    ...
    def fetch_price(
        self, item_hash_name: str, game: GameOptions, currency: Currency = Currency.USD
    ) -> dict:
    ...
    def create_sell_order(
        ...
        response = self._session.post(
            SteamUrl.COMMUNITY_URL + "/market/sellitem/", json=data, headers=headers
        ).json()
