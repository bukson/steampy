...
def get_market_listings_from_html(html: str) -> dict:
    ...
    sell_listings_dict: Dict[str, Dict[str, Union[str, bool]]] = {}
    buy_orders_dict: Dict[str, Dict[str, str]] = {}
    for node in nodes:
...
def get_sell_listings_from_node(node: Tag) -> Dict[str, Dict[str, Union[str, bool]]]:
...
def get_buy_orders_from_node(node: Tag) -> dict:
    buy_orders_raw = node.findAll("div", {"id": re.compile(r"mybuyorder_\d+")})
    buy_orders_dict = {}
